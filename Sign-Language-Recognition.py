...
mylabel1= Label(win,text='Sign Language Detection',font=('Comic Sans MS',26,'bold'),bd=5,bg='#20262E',fg='#F5EAEA',relief=GROOVE,width=5000 ).pack(pady=20,padx=500)
...
namee = Label(win,text='Bhavishya', font=('Verdana',14,'bold'),relief=GROOVE,width = 22,bd=5, fg="#F5EAEA", bg="#20262E")
namee.place(x=1200,y=650)
rollno = Label(win,text='709', font=('Verdana',14,'bold'),relief=GROOVE,width = 22,bd=5, fg="#F5EAEA", bg="#20262E")
